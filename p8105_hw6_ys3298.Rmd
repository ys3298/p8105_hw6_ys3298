...
From the plot, we noticed that the rmse for model only consider the main effects are pretty high. The model consider interactions are relatively high compared with the BIC model. 
